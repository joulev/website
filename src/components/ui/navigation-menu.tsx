  ...
  >
    ...
    <div className={cn("absolute top-full flex justify-center md:left-1/2 md:-translate-x-1/2")}>
      <NavigationMenuPrimitive.Viewport
        className={cn(
          "card relative mt-2 h-[--radix-navigation-menu-viewport-height] w-full origin-[top_center] overflow-hidden rounded-full bg-bg-idle backdrop-blur transition-all",
  ...
  return (
    <Link href={href} passHref legacyBehavior unstyled>
      <NavigationMenuPrimitive.Link
        ref={ref}
        className={cn(
          "hover-bg relative rounded-full px-4 py-2 text-text-secondary transition-colors hover:bg-bg-idle hover:text-text-primary focus:outline-none active:bg-bg-active active:text-text-primary disabled:pointer-events-none disabled:opacity-50",
